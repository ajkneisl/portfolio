            ...
            <div className="space-y-8">
                            ...
                            return (
                                <div key={i} className="rounded-lg hover:bg-neutral-50 transition-colors">
                                    ...
                                    >
                                        ...
                                        {exp.icon ? (
                                            <div
                                                className="w-10 h-10 sm:w-12 sm:h-12 rounded bg-white border border-neutral-200 flex-shrink-0 flex items-center justify-center p-1">
                                                <img src={exp.icon} alt={exp.company}
                                                     className="w-full h-full object-contain" />
                                            </div>
                                        ) : (
                                            <div
                                                className="w-10 h-10 sm:w-12 sm:h-12 rounded bg-gray-100 flex-shrink-0 flex items-center justify-center text-black font-semibold text-base sm:text-lg">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex flex-col sm:flex-row sm:items-baseline sm:gap-2">
                                                ...
                                                <span
                                                    className="text-xs sm:text-sm text-neutral-600">at {exp.company}</span>
                                            </div>
                                            <div
                                            ...
                                            <span
                                                className="text-xs text-neutral-500 sm:hidden mt-1 block">{exp.year}</span>
                                        </div>

                                        {/* Date and Link */}
                                        <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0 pt-0.5">
                                            <span
                                                className="text-xs text-neutral-500 hidden sm:inline">{exp.year}</span>
                                            {exp.link && (
                                                <a
                                                    href={exp.link}
                                                    target="_blank"
                                                ...
                                                >
                                                    <img src="/link.svg" alt="External Link"
                ...
                <section>
                    ...
                    <div className="space-y-2">
                        {projects.map((proj, i) => (
                            <div key={i}
                                 className="flex items-center gap-3 sm:gap-4 p-2 sm:p-3 rounded-lg hover:bg-neutral-50 transition-colors cursor-pointer">
                                {/* Icon */}
                                {proj.icon ? (
                                    <div
                                        className="w-10 h-10 sm:w-12 sm:h-12 rounded bg-white border border-neutral-200 flex-shrink-0 flex items-center justify-center p-1">
