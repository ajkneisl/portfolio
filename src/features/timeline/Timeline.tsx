        ...
        <div className="bg-white text-neutral-800 p-8 w-full min-h-screen">
            <div className="max-w-4xl mx-auto space-y-8">
                            ...
                            return (
                                <div key={i} className="rounded-lg hover:bg-neutral-50 transition-colors">
                                    ...
                                    >
                                        {/* Icon */}
                                        {exp.icon ? (
                                            <div className="w-12 h-12 rounded bg-white border border-neutral-200 flex-shrink-0 flex items-center justify-center p-1">
                                                <img src={exp.icon} alt={exp.company} className="w-full h-full object-contain" />
                                            </div>
                                        ) : (
                                            <div className="w-12 h-12 rounded bg-gray-200 flex-shrink-0 flex items-center justify-center text-black font-semibold text-lg">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-baseline gap-2">
                                                ...
                                                <span className="text-sm text-neutral-600">at {exp.company}</span>
                                            </div>
                                        ...
                                        <div className="flex items-center gap-2 flex-shrink-0 pt-0.5">
                                            ...
                                            {exp.link && (
                                                <a
                                                    ...
                                                    className="p-2 hover:bg-neutral-200 rounded transition-colors cursor-pointer"
                                                    onClick={(e) => e.stopPropagation()}
                                                >
                                                    <img src="/link.svg" alt="External Link" className="w-5 h-5 opacity-70" />
                                                </a>
                                            )}
                                            {/* Chevron indicator */}
                                            <svg
                                                className={`w-5 h-5 text-neutral-400 transition-transform duration-500 ease-in-out ${isExpanded ? 'rotate-180' : ''}`}
                                                fill="none"
                                                stroke="currentColor"
                                                viewBox="0 0 24 24"
                                            >
                ...
                <section>
                    ...
                    <div className="space-y-2">
                        {projects.map((proj, i) => (
                            <div key={i} className="flex items-center gap-4 p-3 rounded-lg hover:bg-neutral-50 transition-colors cursor-pointer">
                                {/* Icon */}
                                {proj.icon ? (
                                    <div className="w-12 h-12 rounded bg-white border border-neutral-200 flex-shrink-0 flex items-center justify-center p-1">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-sm text-neutral-600 truncate">{proj.subtitle}</p>
                                ...
                                <div className="flex items-center gap-2 flex-shrink-0">
                                    ...
                                    <span className="text-xs text-neutral-500">{proj.year}</span>
                                </div>
                            </div>
                        ))}
                    </div>
